...
function updateCountdown() {
    ...
    if (timeDifference <= 0) {
        countdownElement.textContent = "OG Season 4 has concluded.";
        countdownElement.innerHTML = "Downtime is currently active for the release of OG Season 5. Stay tuned!"
    } else {
        ...
        countdownElement.innerHTML = "OG Season 4 will end in:<br> " + '<span style="font-size:100px;">' + days + ":" + hours + ":" + minutes + ":" + seconds + '</span>';
